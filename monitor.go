...
type Status struct {
	Available bool
	Kind      InterfaceKind
	// Generation identifies the native network path observed by this monitor. It begins at 1 and
	// advances when the native network path changes. Unsupported platforms report 0.
	Generation uint64
